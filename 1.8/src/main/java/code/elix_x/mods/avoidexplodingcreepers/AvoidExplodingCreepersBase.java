...
@Mod(modid = AvoidExplodingCreepersBase.MODID, name = AvoidExplodingCreepersBase.NAME, version = AvoidExplodingCreepersBase.VERSION, dependencies = "required-after:" + EXCore.DEPENDENCY, acceptableRemoteVersions = "*", acceptedMinecraftVersions = "1.8")
